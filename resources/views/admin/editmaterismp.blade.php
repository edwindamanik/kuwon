    ...
    <div class="container">
        <div class="title">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="{{ URL('/kelola-materi/smp') }}">Materi SMP</a></li>
                <li>Edit Materi SMP</li>
            </ul>
        </div>
        ...
        <div class="category">
            ...
            <div class="formEditMateri">
                @foreach ($editDataMateri as $materi)
                    <form action="/kelola-materi/smp/update" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <textarea type="text" cols="30" rows="10" name="deskripsiMateri" required>{{ $materi->deskripsiMateri }}</textarea>

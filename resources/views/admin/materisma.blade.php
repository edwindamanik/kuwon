    ...
    <div class="container">
        ...
        <div class="category">
            ...
            <div class="formSearch">
                <form action="{{ URL('/kelola-materi/sma/search') }}" method="get">
                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="1"><a href="/kelola-materi/sma/{{ $post->id }}/edit" class="editButton">Edit</a></td>

...
@section('mainContent')
    <div class="container">
        ...
        <div class="contentTambahSoal">
            ...
            <form action="{{ URL('/soal/prosesSoal') }}" method="post" enctype="multipart/form-data" id="formActionSoal2">
                @csrf
                ...
                <div class="formatPenambahanSoal">
                    ...
                    @enderror<br>
                    <input type="hidden" name="tingkatPendidikan" value="sma">
                </div>
            </form>
            <div class="tambahJumlahSoal">
                <a type="click" class="deretanSoal" onclick="deretanSoal2()">Tambah Soal&nbsp;<i class="fas fa-plus-circle"></i></a>
            </div>

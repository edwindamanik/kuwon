...
@section('mainContent')
    <div class="container">
        ...
        <div class="contentTambahSoal">
            ...
            <form action="{{ URL('/soal/prosesSoal') }}" method="post" enctype="multipart/form-data" id="formActionSoal">
                @csrf
                ...
                <div class="formatPenambahanSoal">
                    ...
                    @enderror<br>
                    <input type="hidden" name="tingkatPendidikan" value="smp">
                </div>
            </form>
            <div class="tambahJumlahSoal">
                <a type="click" class="deretanSoal" onclick="deretanSoal()">Tambah Soal&nbsp;<i class="fas fa-plus-circle"></i></a>
            </div>
            <button type="submit" form="formActionSoal">Kirim Soal</button>
        </div>

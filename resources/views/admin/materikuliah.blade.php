...
@section('title', 'Kelola materi Kuliah')
...
@section('mainContent')
    <div class="container">
        ...
        <div class="category">
            <p>Ini materi Kuliah</p>
            <div class="formSearch">
                <form action="{{ URL('/kelola-materi/kuliah/search') }}" method="get">
                    <input type="text" name="search" placeholder="Masukkan keyword pencarian" required>
                    <button type="submit">Cari</button>
                </form>
            </div>
            <div class="notifUpdate">
                @if (session()->has('ubahBerhasil2'))
                    <p>
                        {{ session('ubahBerhasil2') }}
                    </p>
                @endif
            </div>
            <div class="notifUpdate">
                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="1"><a href="/kelola-materi/kuliah/{{ $post->id }}/edit" class="editButton">Edit</a></td>
